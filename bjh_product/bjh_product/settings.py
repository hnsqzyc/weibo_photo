...
BOT_NAME = 'bjh_product'

SPIDER_MODULES = ['bjh_product.spiders']
NEWSPIDER_MODULE = 'bjh_product.spiders'
...
BACKUPS_NORMAL_TABLE = 'backups_normal_table'
ING_TABLE = 'ing_table'
...
# ITEM_PIPELINES = {
#    'bjh_product.pipelines.BjhProductPipeline': 300,
# }

DOWNLOADER_MIDDLEWARES = {
    # 'bjh_product.middlewares.ResourceMiddleware' : 390,
    # 'scrapy.downloadermiddlewares.useragent.UserAgentMiddleware' : 400,
    # 'bjh_product.middlewares.UserAgentMiddleware' :401,
    # 'bjh_product.middlewares.CookiesMiddleware' :402,
    'bjh_product.middlewares.ProxyMiddleware': 740,
